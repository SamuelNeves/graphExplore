...
// configuration step. It creates a namespace called `graphExplore`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", graphExplore::cmake::project_name, graphExplore::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", graphExplore::cmake::project_version);
      return EXIT_SUCCESS;
    }
